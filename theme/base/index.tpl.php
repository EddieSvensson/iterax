...
<?php if(RegionHaveContent('regions','flash')): ?>
    <div id='outer-wrap-flash'>
        <div id='inner-wrap-flash'>
            <div id='flash'><?=PrintData('regions','flash')?></div>
        </div>
    </div>
...
<?php if(RegionHaveContent('regions','flash2')): ?>
    <div id='outer-wrap-flash-2'>
        <div id='inner-wrap-flash-2'>
            <div id='flash-2'><?=PrintData('regions','flash2')?></div>
        </div>
    </div>
<?php endif; ?>
        ...
        <div id='inner-wrap-featured'>
            <div id="center-featured">
                ...
                <?php if(RegionHaveContent('regions','over-featured')): ?>
                    <div id='over-featured'><?=PrintData('regions','over-featured')?></div>
                <?php endif;?>

                <div id='featured-first'><?=PrintData('regions','featured-first')?></div>
                <?php if(!RegionHaveContent('regions','featured-middle')): ?>
                    <div id='featured-middle-default'><?=PrintData('regions','featured-middle')?></div>
                <?php else: ?>
                    <div id='featured-middle'><?=PrintData('regions','featured-middle')?></div>
                <?php endif; ?>
                <div id='featured-last'><?=PrintData('regions','featured-last')?></div>
                <div class="clear"></div>
            </div>
        </div>
        <div class="clear"></div>
